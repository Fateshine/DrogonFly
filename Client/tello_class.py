...
class Tello_drone:
    ...
    def __init__(self, i_x: int = 0, i_y: int = 0, i_z: int = 90, i_r: int = 0):
    ...
    def add_waypoints_database(self, wp):
        ...
        #     self.waypoints.append(new_waypoint)
        self.waypoints=[(row.x,row.y,row.z) for row in wp.itertuples()]
